...
@click.command()
@click.option('--organism_name', required=True, type=str,
              help='The name of organism.')
@click.option('--organism_type', default="plants", type=str,
              help='The type of the organism.')
@click.option('--release', default="current", type=str, prompt='Release', help='The release version.')
@click.option('--output_dir', default=os.path.join(os.getcwd(), "ftp_output"),
